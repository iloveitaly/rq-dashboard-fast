...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'btn-view': 'btn-icon bg-gray-50 text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800/40 dark:text-gray-400 dark:hover:bg-gray-700/60 dark:hover:text-gray-200 no-underline',
    ...
    'btn-skeleton': 'btn-icon bg-transparent text-gray-200 dark:text-gray-700 cursor-not-allowed',
